...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/yves rocher.png" alt="cosrx logo" style="height: 300px;display: block; margin: auto;">
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            ...
            $select_stmt = $db->prepare("SELECT * FROM product WHERE brand_category = 'yves rocher'");
            $select_stmt->execute();
