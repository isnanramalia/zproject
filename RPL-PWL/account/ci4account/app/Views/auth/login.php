                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><?= lang('Auth.loginTittle') ?></h1>
                                </div>
                                ...
                                <form action="<?= route_to('login')  ?>" method="post" class="user">
                                    ...
                                    <?php if ($config->validFields === ['email']) { ?>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user <?php if (session('errors.login')) { ?>is-invalid<?php } ?>" name="login" placeholder="<?= lang('Auth.email') ?>">
                                    ...
                                    <?php } else { ?>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user <?php if (session('errors.login')) { ?>is-invalid<?php } ?>" name="login" placeholder="<?= lang('Auth.emailOrUsername') ?>">
                                            <div class="invalid-feedback">
                                                <?= session('errors.login')  ?>
                                            </div>
                                        </div>
