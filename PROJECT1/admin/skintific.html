...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/skintific.png" alt="skintific logo"
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="../atribut/best seller/skitific.png" alt="moisturizer skintific">
                <section class="card-body">
                    <h2 class="card-title">SKINTIFIC Moisturizer Best Seller</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/skintific/set bundle/set bundle.jpg"
                    alt="skintific set bundle">
                <section class="card-body">
                    <h2 class="card-title">SKINTIFIC Set Bundle</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
