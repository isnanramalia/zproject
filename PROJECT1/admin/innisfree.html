...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/innisfree.png" alt="innisfree logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">Innisfree</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/cleanser/cleanser.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/exfoliant/exfoliant.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Exfoliant</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/eye treatment/eye.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Eye</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/lipCare/lip.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Lip Care</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/mask/mask.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Mask</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/moisturizer/moisturizer.jpg"
                    alt="innisfree product">
                <section class="card-body">
            ...
            <!-- Start of Card Deck Layout -->
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/serum/serum.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/sunscreen/sunscreen.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/toner/toner.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Toner</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/innisfree/set bundle/set bundle.jpg" alt="innisfree product">
                <section class="card-body">
                    <h2 class="card-title">INNISFREE Set Bundle</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
