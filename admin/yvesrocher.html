...
<head>
    ...
    <title>yves rocher- skinker</title>
</head>
...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/yves rocher.png" alt="yvesrocher logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">YVES ROCHER</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/yvesrocher/set bundle/set bundle.jpg"
                    alt="yves rocher set bundle">
                <section class="card-body">
                    <h2 class="card-title">YVES ROCHER Set Bundle</h2>
