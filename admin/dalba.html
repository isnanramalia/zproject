...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/dalba.png" alt="dalba logo" style="height: 300px;display: block; margin: auto;">
        </section>
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">D'alba</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/dalba/cleanser/cleanser.jpg" alt="dalba product">
                <section class="card-body">
                    <h2 class="card-title">D'ALBA Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/dalba/eye treatment/eye.jpg" alt="dalba product">
                <section class="card-body">
                    <h2 class="card-title">D'ALBA Eye Treatment</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/dalba/lipCare/lip.jpg" alt="dalba product">
                <section class="card-body">
                    <h2 class="card-title">D'ALBA Lip Care</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/dalba/mask/mask.jpg" alt="dalba product">
                <section class="card-body">
                    <h2 class="card-title">D'ALBA Face Mask</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/dalba/moisturizer/moisturizer.jpg" alt="dalba product">
                <section class="card-body">
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/dalba/serum/serum.jpg" alt="dalba product">
                <section class="card-body">
                    <h2 class="card-title">D'ALBA Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <!-- Start of Card Deck Layout -->
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/dalba/sunscreen/sunscreen.jpg" alt="dalba product">
                <section class="card-body">
                    <h2 class="card-title">D'ALBA Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/dalba/toner/toner.jpg" alt="dalba product">
                <section class="card-body">
                    <h2 class="card-title">D'ALBA Toner</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
