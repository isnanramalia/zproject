...
<head>
    ...
    <title>The Ordinary- skinker</title>
</head>
...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/the ordinary.png" alt="theOrdinary logo"
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="../atribut/best seller/the ordianry.png" alt="the ordinary set bundle"
                    section class=" card-body">
                <section class="card-body">
                    <h2 class="card-title">THE ORDINARY Serum</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/theOrdinary/set bundle/set bundle.jpg"
                    alt="the ordinary set bundle" section class=" card-body">
                <section class="card-body">
                    <h2 class="card-title">THE ORDINARY Set Bundle Hydration</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
