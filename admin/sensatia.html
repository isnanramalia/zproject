...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/sensatia.png" alt="sensatia logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">Sensatia</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/sensatia/set bundle/set bundle combination skin.jpg"
                    alt="sensatia set bundle">
                <section class="card-body">
                    <h2 class="card-title">SENSATIA Set Bundle combination skin</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/sensatia/set bundle/set bundle dry skin.jpg"
                    alt="sensatia set bundle">
                <section class="card-body">
                    <h2 class="card-title">SENSATIA Set Bundle Dry Skin</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/sensatia/set bundle/set bundle normal skin.jpg"
                    alt="sensatia set bundle">
                <section class="card-body">
                    <h2 class="card-title">SENSATIA Set Bundle Normal Skin</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/sensatia/set bundle/set bundle sensitive skin.jpg"
                    alt="sensatia set bundle">
                <section class="card-body">
                    <h2 class="card-title">SENSATIA Set Bundle Sensitive Skin</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
