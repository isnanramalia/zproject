...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/laneige.png" alt="laneige logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">Laneige</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/cleanser/cleanser.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/exfoliant/exfoliant.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Exfoliant</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/eye treatment/eye.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Eye</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/lipCare/lip.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Lip Care</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/mask/mask cica green.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Mask Cica</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/mask/mask purple.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Mask Purple</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <!-- Start of Card Deck Layout -->
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/moisturizer/moisturizer.jpg" alt="laneige product">
                <section class="card-body">
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/serum/serum.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/sunscreen/sunscreen.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/laneige/toner/toner.jpg" alt="laneige product">
                <section class="card-body">
                    <h2 class="card-title">LANEIGE Toner</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
