...
<head>
    ...
    <title>mario badescu - skinker</title>
</head>
...
<body style="background-color: #D4DDB7;">
    ...
    <!------------------------------MARIOBASECU PRODUCTS-------------------------->
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/maraobadescu.png" alt="mariobadescu logo"
                style="height: 300px;display: block; margin: auto;">
        </section>
        <section
            style="background-color: white; font-size: medium; padding: 10px;margin: 10px;border: 0.3px solid  rgba(0, 0, 0, 0.3); border-top-left-radius: 50%; border-bottom-right-radius: 50%;">
            <h1 style="font-size: medium; text-align: center;">Mario Basescu</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/cleanser/cleanser.jpg"
                    alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/exfoliant/exfoliant.jpg"
                    alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Exfoliant</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/eye treatment/eye.jpg"
                    alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Eye</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/lipCare/lip.jpg" alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Lip Care</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/mask/mask.jpg" alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Mask</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/serum/serum.jpg" alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <!-- Start of Card Deck Layout -->
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/set bundle/set bundle coconut body trio.jpg"
                    alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Set Bundle Coconut Body Trio</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/set bundle/set bundle mini mist collection.jpg"
                    alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Set Bundle Mini Mist Collection</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/sunscreen/sunscreen.jpg"
                    alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/mariobadescu/toner/toner.jpg" alt="mario badescu product">
                <section class="card-body">
                    <h2 class="card-title">MARIO BADESCU Toner</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
    ...
    <footer class="text-center text-lg-start border border-white mt-xl-5 pt-4" style="background-color: white;">
        ...
        <section class="container text-center">
            <section class="row">
                ...
                <section class="col">
                    <img class="cap" style="height: 100px;" src="../atribut/payment method/shopeepay.png"
                        alt="shopeepay">
                </section>
                <section class="col">
                </section>
