...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">COSRX</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cosrx/cleanser/cleanser.jpg" alt="cosrx product">
                <section class="card-body">
                    <h2 class="card-title">COSRX Cleanser</h2>
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cosrx/eye treatment/eye hydrogel.jpg" alt="cosrx product">
                <section class="card-body">
                    <h2 class="card-title">COSRX Eye serumHydrogel</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cosrx/eye treatment/eye peptide.jpg" alt="cosrx product">
                <section class="card-body">
                    <h2 class="card-title">COSRX Eye serumPeptide</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cosrx/mask/mask.jpg" alt="cosrx product">
                <section class="card-body">
                    <h2 class="card-title">COSRX Mask</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <!-- Start of Card Deck Layout -->
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cosrx/moisturizer/moisturizer.jpg" alt="cosrx product">
                <section class="card-body">
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cosrx/serum/serum.jpg" alt="cosrx product">
                <section class="card-body">
                    <h2 class="card-title">COSRX Face Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cosrx/sunscreen/sunscreen.jpg" alt="cosrx product">
                <section class="card-body">
                    <h2 class="card-title">COSRX Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cosrx/toner/toner.jpg" alt="cosrx product">
                <section class="card-body">
                    <h2 class="card-title">COSRX Toner</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
