...
<body style="background-color: #D4DDB7;">
    ...
    < !------------------------------CETAPHIL PRODUCTS-------------------------->
        <section class="col-10 py-5 mx-auto">
            <section><img src="../atribut/brand/cetaphil.png" alt="cosrx logo" style="height: 300px;display: block; margin: auto;"></section>
            ...
            < !-- Start of Card Deck Layout -->
                <section class="card-deck d-flex justify-content-center"><?php
                            ...
                            <form class="form-submit"><input type="hidden" class="pid" value="<?php echo $product_id ?>"><input type="hidden" class="pname" value="<?php echo $product_name ?>"><input type="hidden" class="pprice" value="<?php echo $product_price ?>"><input type="hidden" class="pimage" value="<?php echo $product_image ?>"><input type="hidden" class="pcode" value="<?php echo $product_code ?>">
                                <div class="card-body"><img class="card-img-top" src="<?php echo $product_image ?>" alt="<?php echo $product_name ?>">
                                    <h2 class="card-title"><?php echo $product_name ?></h2>
                                    <p class="card-text price">IDR <?php echo number_format($product_price, 2) ?></p><button id="addItem" class="btn btn-block">Add to Cart</button>
                                </div>
                            </form>
                        </section><?php
                                                                            }
