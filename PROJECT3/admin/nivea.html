...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/nivea.png" alt="nivea logo" style="height: 300px;display: block; margin: auto;">
        </section>
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">Nivea</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/nivea/cleanser/cleanser.jpg" alt="nivea product">
                <section class="card-body">
                    <h2 class="card-title">NIVEA Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/nivea/lipCare/lip.jpg" alt="nivea product">
                <section class="card-body">
                    <h2 class="card-title">NIVEA Lip</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/nivea/sunscreen/sunscreen.jpg" alt="nivea product">
                <section class="card-body">
                    <h2 class="card-title">NIVEA Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
