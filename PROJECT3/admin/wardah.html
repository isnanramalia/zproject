...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/wardah.png" alt="wardah logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">Wardah</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="../atribut/best seller/skitific.png" alt="Card image cap">
                <section class="card-body">
                    <h2 class="card-title">Moisturizer Skintific</h2>
