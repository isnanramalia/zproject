...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/estee lauder.png" alt="esteelauder logo"
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/esteelauder/cleanser/cleanser.jpg" alt="estee lauder product">
                <section class="card-body">
                    <h2 class="card-title">ESTEE LAUDER Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/esteelauder/eye treatment/eye.jpg" alt="estee lauder product">
                <section class="card-body">
                    <h2 class="card-title">ESTEE LAUDER Eye</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/esteelauder/lipCare/lip.jpg" alt="estee lauder product">
                <section class="card-body">
                    <h2 class="card-title">ESTEE LAUDER Lip Care</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/esteelauder/moisturizer/moisturizer.jpg"
                    alt="estee lauder product">
                <section class="card-body">
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/esteelauder/serum/serum.jpg" alt="estee lauder product">
                <section class="card-body">
                    <h2 class="card-title">ESTEE LAUDER Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/esteelauder/sunscreen/sunscreen.jpg"
                    alt="estee lauder product">
                <section class="card-body">
                    <h2 class="card-title">ESTEE LAUDER Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
