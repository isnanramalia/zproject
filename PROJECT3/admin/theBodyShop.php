...
<head>
    ...
    <title>The Body Shop- skinker</title>
</head>
...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/the body shop.png" alt="theBodyShop logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">THE BODY SHOP</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/theBodyShop/set bundle/set bundle.jpg"
                    alt="the body shop set bundle">
                <section class="card-body">
                    <h2 class="card-title">THE BODY SHOP Set Bundle</h2>
