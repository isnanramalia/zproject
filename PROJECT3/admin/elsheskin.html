...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/elsheskin.png" alt="elseskin logo"
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/elsheskin/cleanser/cleanser.jpg" alt="elsheskin product">
                <section class="card-body">
                    <h2 class="card-title">ELSHESKIN Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/elsheskin/moisturizer/moisturizer.jpg"
                    alt="elsheskin product">
                <section class="card-body">
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/elsheskin/serum/serum.jpg" alt="elsheskin product">
                <section class="card-body">
                    <h2 class="card-title">ELSHESKIN Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/elsheskin/sunscreen/sunscreen.jpg" alt="elsheskin product">
                <section class="card-body">
                    <h2 class="card-title">ELSHESKIN Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/elsheskin/toner/toner.jpg" alt="elsheskin product">
                <section class="card-body">
                    <h2 class="card-title">ELSHESKIN Toner</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
