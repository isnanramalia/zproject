...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/skii.png" alt="sk-ii logo" style="height: 300px;display: block; margin: auto;">
        </section>
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">SK-II</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/sk-ii/set bundle/set bundle pitera aura.jpg"
                    alt="sk-ii bundle">
                <section class="card-body">
                    <h2 class="card-title">SK-II Set Bundle Pitera </h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/sk-ii/set bundle/set bundle pitera power.jpg"
                    alt="sk-ii bundle">
                <section class="card-body">
                    <h2 class="card-title">SK-II Set Bundle Pitera </h2>
                    <p class="card-text">IDR 200.000</p>
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/sk-ii/set bundle/set bundle pitera welcome.jpg"
                    alt="sk-ii bundle">
                <section class="card-body">
                    <h2 class="card-title">SK-II Set Bundle Pitera </h2>
                    <p class="card-text">IDR 200.000</p>
