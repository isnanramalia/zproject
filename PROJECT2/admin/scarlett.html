...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/scarlett.png" alt="scarlett logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">Scarlett</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/scarlett/cleanser/cleanser.jpg" alt="scarlett product">
                <section class="card-body">
                    <h2 class="card-title">SCARLETT Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/scarlett/eye treatment/eye.jpg" alt="scarlett product">
                <section class="card-body">
                    <h2 class="card-title">SCARLETT Treatment Eye</h2>
                    <p class="card-text">IDR 75.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/scarlett/moisturizer/moisturizer acne day.jpg"
                    alt="scarlett product">
                <section class="card-body">
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/scarlett/moisturizer/moisturizer acne night.jpg"
                    alt="scarlett product">
                <section class="card-body">
