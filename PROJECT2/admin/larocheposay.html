...
<head>
    ...
    <title>la roche posay - skinker</title>
</head>
...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/la roche-posay.png" alt="larocheposay logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">La Roche Posay</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/larocheposay/cleanser/cleanser.jpg"
                    alt="la roche posay product">
                <section class="card-body">
                    <h2 class="card-title">LA ROCHE POSAY Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/larocheposay/moisturizer/moisturizer.jpg"
                    alt="la roche posay product">
                <section class="card-body">
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/larocheposay/serum/serum.jpg" alt="la roche posay product">
                <section class="card-body">
                    <h2 class="card-title">LA ROCHE POSAY Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/larocheposay/sunscreen/sunscreen.jpg"
                    alt="la roche posay product">
                <section class="card-body">
                    <h2 class="card-title">LA ROCHE POSAY Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/larocheposay/toner/toner.jpg" alt="la roche posay product">
                <section class="card-body">
                    <h2 class="card-title">LA ROCHE POSAY Toner</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
