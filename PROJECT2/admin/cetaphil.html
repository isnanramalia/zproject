...
<body style="background-color: #D4DDB7;">
    ...
    <section class="col-10 py-5 mx-auto">
        <section>
            <img src="../atribut/brand/cetaphil.png" alt="cetaphil logo"
        ...
        <section
            ...
            <h1 style="font-size: medium; text-align: center;">Cetaphil</h1>
        </section>
        ...
        <section class="card-deck d-flex justify-content-center">
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cetaphil/cleanser/cleanser.jpg" alt="cethapil product">
                <section class="card-body">
                    <h2 class="card-title">CETAPHIL Cleanser</h2>
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cetaphil/exfoliant/exfoliant.jpg" alt="cethapil product">
                <section class="card-body">
                    <h2 class="card-title">CETAPHIL Exfoliant</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cetaphil/moisturizer/moisturizer.jpg" alt="cethapil product">
                <section class="card-body">
            ...
            <section class="card col-2 " style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="../atribut/best seller/cetaphil.png" alt="cethapil product">
                <section class="card-body">
                    <h2 class="card-title">CETAPHIL Moisturizer Best Seller</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cetaphil/serum/serum.jpg" alt="cethapil product">
                <section class="card-body">
                    <h2 class="card-title">CETAPHIL Serum</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
            ...
            <section class="card col-2" style="margin: 10px; padding: 10px;">
                <img class="card-img-top" src="imgProduct/cetaphil/sunscreen/sunscreen.jpg" alt="cethapil product">
                <section class="card-body">
                    <h2 class="card-title">CETAPHIL Sunscreen</h2>
                    <p class="card-text">IDR 200.000</p>
                    <button class="btn btn-block">Buy Now</button>
                </section>
                <!-- End of Card Deck Layout -->
