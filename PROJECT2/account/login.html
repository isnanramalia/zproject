...
<body style="margin-top: 50px; padding-top: 290px;">
    <header>
        ...
        <section class="main">
            ...
            <a><b>|</b></a>
            <a href="register.html" class="active">ACCOUNT <i class="ri-user-fill"></i></a>
            ...
            <section class="row">
                ...
                <section class="col-6">
                    ...
                    <span style="color: rgba(43, 43, 43, 0.2); display: flex;justify-content: center;">Don't have an
                        account yet?</span>
                    <a href="register.html" class="href-login">CREATE ACCOUNT</a>
                </section>
                <section class="col-3"></section>
            </section>
        </section>
            ...
            <section class="row">
                ...
                <section class="col-lg-4 col-md-4 mb-3 mb-lg-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="register.html" class="text-black">Sign In</a>
                        </li>
                    </ul>
                </section>
                <!--Grid column-->
